...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CYUoHpcR.js
var router_CYUoHpcR_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CS2j7VP3.css";
var APP_NAME = "Arcxnjo";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Arcxnjo Painel — Aimbot, ESP e No Recoil."
			},
			{
				name: "theme-color",
				content: "#08090b"
...
var $$splitComponentImporter = () => import("./routes-Ci2Ev6tV.mjs");
...
//#endregion
export { getRouter, router_CYUoHpcR_exports as t };
